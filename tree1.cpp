...
int search(int curr, int preoder[], int inorder[], int start, int end)
{
...
Node *buildtree(int preorder[], int inorder[], int start, int end)
{
    ...
    idx++;
    int pos = search(curr, preorder, inorder, start, end);
    Node *node = new Node(curr);
    node->left = buildtree(preorder, inorder, start, pos - 1); //will look at the less side and vise versa
